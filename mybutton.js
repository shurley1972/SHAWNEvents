...
define(['text!./mybutton.html'], function( htmlString) {
...
//debugger;				
    ...
    //componentmybutton.prototype.doSomething = function() { ... };
	mybutton.prototype.schema = {
		"Params": {
			"save": true,
			"cancel": true,
	...
	ko.bindingHandlers.initmybutton = {
    ...
    return { viewModel: mybutton, template: htmlString };
});
